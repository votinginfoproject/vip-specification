...
+====================+================+==============+==============+==========================================+==========================================+
| CandidateId        | ``xs:IDREF``   | Optional     | Repeats      | References a :ref:`multi-xml-candidate`  | If the field is invalid or not present,  |
...
+--------------------+----------------+--------------+--------------+------------------------------------------+------------------------------------------+
| EndorsementPartyId | ``xs:IDREF``   | Optional     | Repeats      | References a :ref:`multi-xml-party`      | If the field is invalid or not present,  |
